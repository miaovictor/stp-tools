export default {
  ...
  login: {
    title: 'Conjunto de herramientas de gestión',
    langSelectTips: 'Cambiar el éxito del lenguaje!',
    logIn: 'Acceso',
    username: 'Usuario',
    validUsernameTips: 'Por favor, introduzca el nombre de usuario correcto',
    password: 'Contraseña',
    validPasswordTips: 'La contraseña no puede ser inferior a 5 dígitos',
    any: 'nada',
